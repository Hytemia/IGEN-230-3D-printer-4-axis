...
; X goes from 0 to 115.5
; B goes from -180 to 90 (maybe wrong)
...
M550 P"theta"                                    ; set printer name

; Network
M552 S1                                  ; Enable WiFi and connect to the network
...
; Fans
; M950 F0 C"fan1"   
M950 F0 C"PD_14"                                           ; create fan 0 on pin fan0 and set its frequency
